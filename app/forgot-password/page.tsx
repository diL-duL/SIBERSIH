            ...
            <form onSubmit={handleVerifyCode} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  maxLength={6}
                  required
                  className="flex h-12 w-full rounded-xl border border-zinc-200 bg-white px-4 py-2 text-center text-lg tracking-[0.5em] font-medium ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-zinc-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-800 dark:bg-zinc-950 dark:ring-offset-zinc-950 dark:placeholder:text-zinc-700 dark:focus-visible:ring-zinc-300 transition-all duration-200"
                />
              </div>
              <button
                type="submit"
