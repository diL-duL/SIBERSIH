...
export default async function PimpinanDashboard() {
    ...
    return (
        <div className="pb-16 pt-6 sm:pt-8 min-h-screen bg-sibersih-bg flex flex-col max-w-5xl mx-auto px-3.5 sm:px-6 lg:px-8 w-full">
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:hidden mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:hidden mb-5">
                <Link
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-sibersih-primary/10 flex flex-col overflow-hidden">
                        <div className="p-3.5 sm:p-4 border-b border-sibersih-primary/5 flex justify-between items-center gap-2 bg-gray-50/50 rounded-t-xl">
                            <div>
                                ...
                                <p className="text-xs text-sibersih-primary/60 mt-0.5">Pemeriksaan bukti hasil pembersihan petugas</p>
                            </div>
                        ...
                        <div className="bg-sibersih-bg/30 p-3 sm:p-4 flex flex-col gap-3 sm:gap-4">
                         {pending === 0 ? (
                             <div className="flex flex-col items-center justify-center text-sibersih-primary/40 gap-3 py-10">
                                ...
                                <span className="font-semibold text-xs sm:text-sm">Tidak ada laporan yang menunggu validasi.</span>
                             </div>
                        ) : (
                            <>
                                {pendingReports.map((report, index) => (
                                    ...
                                    >
                                        <div className="relative w-20 h-20 sm:w-28 sm:h-24 bg-gray-100 rounded-xl overflow-hidden shrink-0 border border-orange-200 shadow-2xs">
                                            <Image src={report.fotoBuktiUrl || report.fotoLaporanUrl} alt="Bukti Kerja" fill sizes="(max-width: 640px) 80px, 112px" className="object-cover group-hover:scale-105 transition-transform duration-500" priority={index === 0} />
                                ...
                                {/* TOMBOL LIHAT DAFTAR VALIDASI LENGKAP */}
                                <div className="pt-1">
                                    <Link
                                        href="/executive/validations"
                                    ...
                                    >
                                        <span>Buka Panel Validasi Lengkap ({pending})</span>
                                        <CheckCircle size={14} />
                                    </Link>
                                </div>
                            </>
