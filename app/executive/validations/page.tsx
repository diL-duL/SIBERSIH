                    ...
                    <div key={item.id} className="bg-white rounded-xl shadow-sm border border-sibersih-primary/10 overflow-hidden">
                        ...
                        <div className="p-5 grid grid-cols-2 gap-4">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="w-full h-32 bg-sibersih-primary/5 border border-sibersih-primary/10 rounded-lg flex flex-col items-center justify-center gap-2 text-sibersih-primary/40">
                                    <ImageIcon size={24} />
                                    <span className="text-xs font-medium uppercase tracking-wider">Foto Awal</span>
                                </div>
                            </div>
                            <div className="flex flex-col gap-2">
