      ...
      <div className="max-w-3xl w-full flex flex-col gap-8">
        ...
        <div className="bg-white rounded-xl p-8 border border-sibersih-primary/10 shadow-sm flex flex-col md:flex-row items-center gap-8 transition-colors hover:border-sibersih-accent">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-sibersih-primary mb-2">Bapak Budi</h1>
            <p className="text-sibersih-primary/60 flex items-center justify-center md:justify-start gap-2 text-sm">
              <Mail className="w-4 h-4" />
              budi@executive.sibersih.com
            </p>
          </div>
                ...
                <div className="animate-in fade-in duration-500">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="p-4 rounded-xl bg-sibersih-bg border border-sibersih-primary/5 hover:border-sibersih-primary/20 transition-colors duration-300">
                      ...
                      <p className="text-sibersih-primary font-semibold text-sm">Bapak Budi</p>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-sibersih-bg border border-sibersih-primary/5 hover:border-sibersih-primary/20 transition-colors duration-300">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sibersih-primary font-semibold text-sm">budi@executive.sibersih.com</p>
                      </div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-sibersih-bg border border-sibersih-primary/5 hover:border-sibersih-primary/20 transition-colors duration-300">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sibersih-primary font-semibold text-sm">Pimpinan / Executive</p>
                      </div>
                    </div>
                ...
                <div className="animate-in fade-in duration-500">
                  ...
                  <form className="space-y-4 max-w-md">
                    <div>
                      ...
                      <input type="text" placeholder="Bapak Budi" className="w-full px-4 py-2 rounded-lg border border-sibersih-primary/10 focus:outline-none focus:ring-2 focus:ring-sibersih-accent focus:border-transparent transition-all text-sm placeholder:text-sibersih-primary/60 text-sibersih-primary" />
                    </div>
                    
                    <div>
                      <label className="block text-sm font-medium text-sibersih-primary/80 mb-1">Email</label>
                      <input type="email" defaultValue="budi@executive.sibersih.com" disabled className="w-full px-4 py-2 rounded-lg border border-sibersih-primary/10 bg-sibersih-primary/5 text-sibersih-primary/60 cursor-not-allowed focus:outline-none transition-all text-sm" />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select disabled className="w-full px-4 py-2 rounded-lg border border-sibersih-primary/10 bg-sibersih-primary/5 text-sibersih-primary/60 cursor-not-allowed focus:outline-none transition-all appearance-none text-sm">
                          <option value="executive">Pimpinan / Executive</option>
                        </select>
